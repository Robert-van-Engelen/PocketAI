' Escape from Alcatraz for the PC-G850
...
'  M$(65,19)*1    prisoner's memory (1320 addresses of one byte)
...
630 IF J=8 LOCATE 19,0: PRINT "oh no": LET J=ABS(RND F-1): GOTO 650
...
' stairs down left
740 IF I=5 OR I=7 OR I=9 OR I=10 LINE (X-2,Y+9)-(X-11,Y+18): LINE (X-3,Y+9)-(X-12,Y+18),&HAAAA
' elevator down
750 IF I>3 IF I<10 IF Y<48 LINE (X+1,Y+8)-(X+3,Y+12),BF
' stairs down right
760 IF I=0 OR I=5 OR I=7 OR I=9 LINE (X+13,Y+9)-(X+22,Y+18): LINE (X+14,Y+9)-(X+23,Y+18),&HAAAA
' floor
770 IF I<>3 IF I<9 LINE (X+13,Y+7)-(X+22,Y+7)
780 NEXT I
' display number of escapes
790 GCURSOR (0,7): X=INT(E/10): GPRINT A$(0);&H81;&HFE;D$(X);&HFE;D$(E-10*X);&HFE
' display number of wins
800 GCURSOR (89,7): X=INT(W/10): GPRINT &HFE;D$(10);&HFE;&H81;A$(1);&HFE;D$(X);&HFE;D$(W-10*X);&HFE
810 RETURN
...
940 GCURSOR (140,15): GPRINT &HFE;D$(10);&HFF;A$(0): GCURSOR (46,23): GPRINT A$(4);A$(3)
950 DIM G(2),M$(65,19)*1,R$(29)*1,S(29),V(7): E=0,W=0,L$="     "
960 WAIT 200: GPRINT
970 RETURN
